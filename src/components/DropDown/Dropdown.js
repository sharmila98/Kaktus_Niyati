...
export default class Dropdown extends Component {
  static defaultProps = {
    ...
    valueExtractor: ({label} = {}, index) => label,
  ...
  onPress(event) {
    ...
    if (data.length !== 0) {
      ...
      this.container.measureInWindow(
      ...
      // constant.toastAlert(
      //   'No sites available, Manage your sites by logging into Safetymint on your desktop browser.',
      //   ToastAndroid.LONG,
      // );
    }
  }
  ...
  onSelect(index) {
    ...
    if ('function' === typeof onChangeText) {
      onChangeText(value, item, index, data);
    }
  }
  ...
  renderBase(props) {
    ...
    this.props.value == '' ? (title = null) : null;
          ...
          style={[
            {
              ...
              alignContent: 'center',
              alignSelf: 'center',
              paddingLeft: constant.HEIGHT * 1.5,
              paddingRight: constant.HEIGHT * 1.5,
              paddingTop: constant.HEIGHT * 1,
              paddingBottom: constant.HEIGHT * 1.5,
              fontFamily:
                Platform.OS === 'ios'
          ...
          {title && isClearable ? (
            <TouchableOpacity onPress={this.props.onClear}>
              <Image
                ...
                source={require('../../assets/icons/IconCloseForm.png')}
              />
            </TouchableOpacity>
          ) : null}
          {type != 'read' ? (
            <Image
              ...
              source={require('../../assets/icons/IconDownArrow.png')}
            />
          ) : null}
        </View>
      </View>
  ...
  render() {
    ...
    let height = 3 * itemPadding + itemSize * visibleItemCount;
          ...
          <Modal
            ...
            <Animated.View
              style={[
                ...
                {backgroundColor: 'rgba(0,0,0,0.58)', alignItems: 'center'},
              ]}
