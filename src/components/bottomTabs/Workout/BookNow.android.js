...
class BookNow extends Component {
  ...
  checkoutPay(resp) {
    try {
      var options = {
        description: 'Workout Trainer Booking',
      ...
      <View style={{flex: 1}}>
        ...
        <SafeAreaView style={{flex: 1, backgroundColor: constant.WHITE}}>
          ...
          <ScrollView
            refreshControl={
              <RefreshControl
                refreshing={this.props.pricing.bookingLoad}
            ...
            <View style={{flex: 1}}>
              ...
              <View style={{flex: 0}}>
                <View
                  ...
                  <BackButtonwithTitle
                    title={'Book a Counselling with a Trainer'}
                    underLine={true}
                  ...
                  <View
                    ...
                    <Text
                      ...
                      Workout Counseling with the experts
                    </Text>
                    <Text
                      style={{
                        fontSize: constant.responsiveFontSize(1.6),
                      ...
                      trainers to meet your fitness goals. Our trainers can
                      design a workout plan and a regimen best suited to your
                      needs.
                    </Text>
