                  ...
                  <View
                    ...
                    <View style={{alignSelf: 'center'}}>
                      <Text
                        ...
                        {this.props.clientProfile.trainerDetails.user_name}
                      </Text>
                      <Text
                        style={{
                          alignSelf: 'flex-end',
                    ...
                    <View
                      ...
                      <TouchableOpacity style={{flexDirection: 'column'}}>
                        <View style={{flexDirection: 'row'}}>
                          <Text
                            ...
                            {
                              this.props.clientProfile.trainerDetails
                                .years_of_exp
                            }
                          </Text>
                          <Text
                      ...
                      <TouchableOpacity
                        ...
                        <Text
                          ...
                          {this.props.clientProfile.trainerDetails.contacts}
                        </Text>
                ...
                <View
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {this.props.clientProfile.trainerDetails.joined_on +
                        ' ago'}
                    </Text>
                    <Text
                      style={{
