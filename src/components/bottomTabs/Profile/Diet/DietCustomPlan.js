...
class DietCustomPlan extends Component {
  constructor(props) {
    super(props);
      ...
      this.props
        ...
        .then((res) => {
          if (res.status == 200) {
            ...
            this.props.onDietCustomPlanListAction(head, url, methods.get);
          }
        });
    } else {
            ...
            <View style={{flex: 0, marginBottom: constant.HEIGHT * 5}}>
              <ScrollView>
                <View
                  ...
                  <FlatList
                    data={this.props.customPlan.dietCustomPlanList}
...
export default connect(mapStateToProps, mapDispatchToProps)(DietCustomPlan);
