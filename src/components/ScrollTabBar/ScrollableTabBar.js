...
export default class ScrollableTabBar extends Component {
  ...
  render() {
    const tabUnderlineStyle = {
      ...
      bottom: 0,
      borderTopLeftRadius: this.props.activeTab == 0 ? 20 : null,
      borderBottomLeftRadius: this.props.activeTab == 0 ? 20 : null,
      borderTopRightRadius: this.props.activeTab == 1 ? 20 : null,
      borderBottomRightRadius: this.props.activeTab == 1 ? 20 : null,
    };
    ...
    return (
      <View
        ...
        <ScrollView
          ...
          horizontal={!this.props.isSearchVisible}
          ...
          <View
            style={[
              styles.tabs,
              {width: this.state.containerWidth, flex: 1},
              this.props.tabsContainerStyle,
            ]}
            ref={'tabContainer'}
            onLayout={
              this.props.disableTabBarOnLayout
                ? undefined
                : this.onTabContainerLayout
            }>
            <Animated.View
              style={[
                tabUnderlineStyle,
